...
print("Az adatfajlban " + str(len(matek)) + " matematika feladat van,  1  pontot er " +
      str(matek.count(1)) + " feladat, 2 pontot er "+ str(matek.count(2)) +
...
print("A válaszok számértéke {}-től {}-ig.".format(min(valaszok),max(valaszok)))
